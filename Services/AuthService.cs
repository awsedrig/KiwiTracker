...
public class AuthService
{
    ...
    {
        var secretKey = _configuration["Jwt:Key"] ?? "SUPER_SECRET_FALLBACK_KEY_FOR_JWT_WHICH_IS_AT_LEAST_32_CHARS_LONG!";
        ...
        var token = new JwtSecurityToken(
            ...
            claims: claims,
            expires: DateTime.UtcNow.AddDays(7), // Дай себе неделю жизни без релогина
